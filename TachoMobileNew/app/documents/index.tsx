...
const DocumentsScreen = () => {
  ...
  const documentsKeys = Object.keys(documents).filter((key) => keysToFilter.indexOf(key) === -1);
        ...
        {documents['updated_at'] && (
          <StyledView className="flex flex-col">
            ...
            <StyledText className="text-md text-darkBlue text-center px-3 mb-12">
              {moment(documents['updated_at']).format('DD.MM.YYYY HH:mm:ss')}
            </StyledText>
          </StyledView>
        )}
        ...
        {documentsKeys.length ? (
          documentsKeys.map((key, idx) => (
            ...
            >
              ...
              />
              <ExpandedData data={documents[key]} expanded={expanded} idx={idx} namesMapper={namesMapper} />
            </StyledView>
          ))
        ) : (
